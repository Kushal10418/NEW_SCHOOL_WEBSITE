...
$admission=filter_input(INPUT_POST,'date',FILTER_SANITIZE_STRING);
...
if (file_exists($file)) {
    ...
    $headers=['Sl.No','Student Name','Gender','Date Of Birth','Current Class','Parent Name','Email','Mobile','Student Password','Admission Date'];
    $col='A';
...
$sheet->setCellValue("J{$row}", $admission);
